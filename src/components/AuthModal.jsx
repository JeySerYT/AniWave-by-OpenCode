        ...
        >
          ...
          >
            ...
            <div className="authmodal-buttons">
              <button className="authmodal-btn primary" onClick={() => { onClose(); navigate('/login'); }}>
                Войти
              </button>
              <button className="authmodal-btn secondary" onClick={() => { onClose(); navigate('/register'); }}>
                Зарегистрироваться
              </button>
            </div>
            ...
            <div className="authmodal-oauth">
              ...
              <button className="authmodal-oauth-btn github" onClick={() => handleOAuth('github')}>
