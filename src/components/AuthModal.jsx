      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className="authmodal-buttons">
              <button className="authmodal-btn primary" onClick={() => { navigate('/login'); }}>
                Войти
              </button>
              <button className="authmodal-btn secondary" onClick={() => { navigate('/register'); }}>
                Зарегистрироваться
              </button>
            </div>

            <div className="authmodal-divider">
            ...
            <div className="authmodal-oauth">
              <button className="authmodal-oauth-btn google" onClick={() => handleOAuth('google')} disabled={oauthLoading}>
              ...
              <button className="authmodal-oauth-btn github" onClick={() => handleOAuth('github')} disabled={oauthLoading}>
