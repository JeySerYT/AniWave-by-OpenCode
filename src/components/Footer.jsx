      ...
      <div className="footer-content">
        ...
        <div className="footer-contact">
          ...
          <div className="footer-social">
            <a href="https://github.com/JeySerYT/AniWave-by-OpenCode" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub">
            ...
            <a href="https://discord.gg/aniwave" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Discord">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
