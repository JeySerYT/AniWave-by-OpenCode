      ...
      >
        ...
        <section>
          ...
          <p>
            ...
            Мы не храним контент на наших серверах — вся информация предоставляется пользователями и открытыми источниками.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Мы не несём ответственности за точность данных, предоставляемых на сайте.
